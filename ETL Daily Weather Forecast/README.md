...
- [Code Explanation.md](./Code%20Explanation.md): Is a line-by-line explanation of `rx_poc.sh`, quoting all the code snippets and explaining each of its functions. 
- [rx_poc.log](./rx_poc.log): Weather report log file (text file containing the meteorological scraped data) obtained by running the script `rx_poc.sh`.
- [rx_poc.sh](./rx_poc.sh): Bash script of the weather report from wttr.in.
- [weather_report](./weather_report): The weather report generated by running the file `rx_poc.sh`.

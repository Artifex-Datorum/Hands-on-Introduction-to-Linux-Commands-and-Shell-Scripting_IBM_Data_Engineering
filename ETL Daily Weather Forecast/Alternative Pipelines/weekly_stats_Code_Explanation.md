...
[weekly_stats.sh](./ETL%20Daily%20Weather%20Forecast/Alternative%20Pipelines/weekly_stats.sh) is a script that reports weekly statistics of historical forecasting accuracy.  
The syntethic historical forecasting accuracy is stored in the file [synthetic_historical_fc_accuracy.tsv](./ETL%20Daily%20Weather%20Forecast/Alternative%20Pipelines/synthetic_historical_fc_accuracy.tsv), which can be downloaded by launching the following command on the terminal.  
